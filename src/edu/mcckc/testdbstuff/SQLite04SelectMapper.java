...
//import java.sql.*;
//
//import edu.mcckc.dao.CustomerMapper;
//import edu.mcckc.domain.*;
//import org.apache.logging.log4j.*;
//
//public class SQLite04SelectMapper
//{
//   private static Logger logger = LogManager.getLogger(SQLite04SelectMapper.class);
//
...
//
//         Customer customer;
//         CustomerMapper mapper = new CustomerMapper(rs);
//
//         while(rs.next())
//         {
//            customer = (Customer)mapper.mapSingleObject();
//
